export {default as accordion} from './template';
...
export function toggleAccordionState(parent, className, evt) {
    ...
    if (toggleInitiated) {
      ...
      if (section.contains(content)) {
        container.addEventListener('transitionend', function handler() {
          ...
          const contentIsClosed = container.style.height === 0 || container.style.height === '0px';
