  ...
  return (
    `<div id=${id} class="carousel-container ${addClassNames(classArr)}">
      ...
      <div class="carousel-controls">
        ${Button({size: 'md', icon: {size: 'md', id: 'chevron-left', title: 'previous item', classArr: ['vert--mid']}, classArr: ['carousel-prev']})}
        ${Button({size: 'md', icon: {size: 'md', title: 'next item', id: 'chevron-right', classArr: ['vert--mid']}, classArr: ['carousel-next']})}
      </div>
    </div>`
  );
