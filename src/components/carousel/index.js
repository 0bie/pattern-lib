import {carouselMarkup} from './template';

document.addEventListener('DOMContentLoaded', appendCarousel);
...
function appendCarousel() {
  ...
  carouselHandler('click', 'carousel');
  carouselHandler('click', 'carousel2');
